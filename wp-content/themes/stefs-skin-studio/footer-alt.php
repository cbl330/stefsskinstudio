				...
				<footer id="footer" class="section-footer">
					<div class="container">
						...
						<div class="col-lg-6 mb-4 mb-lg-0">
							...
							<p>
								<a href="tel:+18435307859"><i class="fas fa-phone-alt me-2"></i>(843) 530-7859</a><br>
								<a href="mailto:stefanie@stefsskinstudio.com"><i class="fas fa-envelope me-2"></i>stefanie@stefsskinstudio.com</a>
							</p>
							</div>
